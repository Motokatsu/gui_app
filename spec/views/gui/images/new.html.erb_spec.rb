...
describe "gui/images/new" do
  before(:each) do
    assign(:gui_image, stub_model(Gui::Image,
      :name => "MyString",
      :style => "MyString",
      :panel_id => 1,
      :dialog_id => 1
  ...
  it "renders new gui_image form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => gui_images_path, :method => "post" do
